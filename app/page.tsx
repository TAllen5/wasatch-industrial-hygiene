...
export default function Home() {
  return <main>
    ...
    <section className="section shell trust-grid"><div className="mountain-panel"><p className="eyebrow">Why Wasatch</p><h2>Built for the field.</h2></div><div className="trust-copy"><p className="eyebrow dark">Credentialed Expertise</p><h3>Certified Industrial Hygienist • Certified Safety Professional</h3><p>CIH and CSP expertise brings scientific rigor, compliance knowledge, and hands-on operational perspective to every engagement.</p><ul><li>Independent, defensible evaluations</li><li>Clear reports and prioritized actions</li><li>Responsive regional support</li><li>Solutions sized to your organization</li></ul></div></section>
