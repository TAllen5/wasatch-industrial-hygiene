  ...
  return (
    <footer className="site-footer">
      <div className="footer-grid">
        ...
        <div><h3>Contact</h3><a href="tel:+14358304444">(435) 830-4444</a><a href="mailto:wasatch.ihandsafety@gmail.com">wasatch.ihandsafety@gmail.com</a><a href="/capability">Capability Statement</a></div>
