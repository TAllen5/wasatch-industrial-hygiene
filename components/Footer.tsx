  ...
  return (
    <footer className="site-footer">
      <div className="footer-grid">
        ...
        <div><h3>Consulting Team</h3><p><strong>Thomas J. Allen, CIH, CSP</strong><br />Industrial Hygiene & Safety</p><p><strong>Bailey Allen, RN</strong><br /><a href="/medical-surveillance">Medical Surveillance & Occupational Health</a></p></div>
      </div>
